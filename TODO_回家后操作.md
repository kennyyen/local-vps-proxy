...
**成功配置了 au 光 + BL1500HM 的端口转发和 VMess 代理服务器！**

详细配置记录请查看：[SETUP_SUCCESS.md](SETUP_SUCCESS.md)

### 最终配置摘要
- ✅ 公网IP: 113.148.4.138
- ✅ 端口 10086 已开放
- ✅ VMess 代理已配置
- ✅ 固定 Mac IP: 192.168.0.2
- ✅ 路由器端口映射正常工作
- ✅ Docker 容器运行正常
...
- [x] 检查网络连接类型：确认为 PPPoE，公网IP = WAN IP
- [x] 简单测试端口转发：Web服务器测试成功
- [x] 配置 DHCP 固定 IP 分配
- [x] 配置端口映射（10086, 8080）
- [x] 配置 DMZ 指向 Mac
- [x] Docker 容器配置和启动
